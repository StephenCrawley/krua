...
SOURCES = src/object.c src/eval.c src/op_unary.c src/op_binary.c src/error.c src/apply.c src/file.c src/adverb_over.c
OBJECTS = src/object.o src/eval.o src/op_unary.o src/op_binary.o src/error.o src/apply.o src/file.o src/adverb_over.o
HEADERS = src/krua.h src/object.h src/eval.h src/limits.h src/op_unary.h src/op_binary.h src/error.h src/apply.h src/file.h src/adverb_over.h
